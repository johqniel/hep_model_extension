...
\begin{itemize}
    \item \textbf{Bifurcated Loops}: 2D and 3D visual rendering are structurally independent. The \texttt{on\_sim\_progress} method utilizes different mathematical paths for drawing flat grids (\texttt{ImageItem}) versus interpolating spherical terrains (\texttt{GLMeshItem}).
