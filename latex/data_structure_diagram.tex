...
\node (agents_array) [smallbox, fill=white] at (world.center) [above=0.8cm] {array[agents]};
...
\node (w_accumulators) [smallbox, fill=white, below=0.3cm of w_grid] {accumulators};
\node (w_dyn_state) [smallbox, fill=white, below=0.3cm of w_config] {dynamic\_state};
\node (w_index_map) [smallbox, fill=white, below=0.3cm of w_accumulators] {index\_map};
