...
\subsection{Legacy/Batch Mode}
For batch processing or headless server runs, you can invoke the compiled binary directly (if built via \texttt{make}) or use python scripts configured for headless execution.
