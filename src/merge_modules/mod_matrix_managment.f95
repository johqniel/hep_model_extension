module matrix_management
    ...
    ! - data managment specific variables: 
        ...
        ! - population_agents_matrix: an array that contains the agents of each population
    ...
    subroutine rearange_matrix_and_kill_agents()
        ...
        do jp = 1, npops
            do i = 1, hum_t(jp)
                agent => population_agents_matrix(i,jp)%node
                ...
                ! if the agent was marked as dead it has to be moved from the list of 
                    ...
                    if (.not. associated(agent))) then
                        print *, "Agent to be removed is not associated with the population_agents_matrix."
                    else 
